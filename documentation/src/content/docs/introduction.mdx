...
`@pobammer-ts/small-rules` is an oxlint-native lint plugin for roblox-ts projects. It provides 86 custom rules that catch common mistakes, enforce consistent patterns, and improve code quality across TypeScript, React Luau, and Roblox-specific APIs.
...
- `oxlint` 1.x (developed and tested against 1.69.0)
- TypeScript `>=5 <8` (for roblox-ts projects)
- Node.js `^20.19.0 || >=22.12.0`
- An oxlint configuration file (`.oxlintrc.json`, or `oxlint.json`)
