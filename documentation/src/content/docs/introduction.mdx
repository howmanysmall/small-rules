...
`@pobammer-ts/small-rules` is an oxlint-native lint plugin for TypeScript projects. It provides 86 custom rules that catch common mistakes, enforce consistent patterns, and improve code quality across TypeScript, React Luau, and Roblox-specific APIs.
