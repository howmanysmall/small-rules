...
interface RuleOptionsTableProperties {
	...
	highlightedTypes?: Readonly<Record<string, string>> | undefined;
	options: ReadonlyArray<ObjectOption>;
}

export function RuleOptionsTable({ highlightedTypes, options }: Readonly<RuleOptionsTableProperties>): ReactNode {
	return (
