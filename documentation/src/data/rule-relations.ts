...
export const ruleRelations = defineRuleRelations([
	...
	},
	{
		...
		kind: "overlaps",
		reason: "This focused rule overlaps no-useless-use-effect's derivedState/mixedDerivedState checks. Enable one to avoid duplicate diagnostics.",
		to: "no-useless-use-effect",
	},
	{
		from: "no-chain-state-updates",
		kind: "overlaps",
		reason: "This focused rule overlaps no-useless-use-effect's effectChain check. Enable one to avoid duplicate diagnostics.",
		to: "no-useless-use-effect",
	},
	{
		from: "no-event-handler",
		kind: "overlaps",
		reason: "This focused rule overlaps no-useless-use-effect's eventFlag/eventSpecificLogic checks. Enable one to avoid duplicate diagnostics.",
		to: "no-useless-use-effect",
	},
	{
		from: "no-adjust-state-on-prop-change",
		kind: "overlaps",
		reason: "This focused rule overlaps no-useless-use-effect's adjustState check. Enable one to avoid duplicate diagnostics.",
		to: "no-useless-use-effect",
	},
	{
		from: "no-reset-all-state-on-prop-change",
		kind: "overlaps",
		reason: "This focused rule overlaps no-useless-use-effect's resetState check. Enable one to avoid duplicate diagnostics.",
		to: "no-useless-use-effect",
	},
	{
		from: "no-pass-live-state-to-parent",
		kind: "overlaps",
		reason: "This focused rule overlaps no-useless-use-effect's notifyParent check. Enable one to avoid duplicate diagnostics.",
		to: "no-useless-use-effect",
	},
	{
		from: "no-pass-data-to-parent",
		kind: "overlaps",
		reason: "This focused rule overlaps no-useless-use-effect's notifyParent check. Enable one to avoid duplicate diagnostics.",
		to: "no-useless-use-effect",
	},
	{
		from: "no-external-store-subscription",
		kind: "overlaps",
		reason: "This focused rule overlaps no-useless-use-effect's externalStore check. Enable one to avoid duplicate diagnostics.",
		to: "no-useless-use-effect",
	},
	{
		from: "no-initialize-state",
		kind: "overlaps",
		reason: "This focused rule overlaps no-useless-use-effect's initializeState check. Enable one to avoid duplicate diagnostics.",
		to: "no-useless-use-effect",
	},
	{
